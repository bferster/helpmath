...
class Interact  {																					
	...
	DragSort(action)																				// RENDER DRAGSORT INTERACTION
	{
		let i,o,str="";
	...
	HandleDone(action)																			// HANDLE DONE WITH INTERACTION
	{
		...
		else						done(action);													// Handle done
		
		function done(action) {																		// Handle done
	...
	Failure(play=false)																			// SETUP OR PLAY FAILURE ANIMATION
	{
